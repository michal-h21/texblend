...
Two crucial properties are \texttt{root}, indicating the relative path to the main file, and
...
You can specify the relative path to the main document in the \verb|root| property.
